...
<File name="functions/nest-cli.json">
  <Nest />
</File>
```json
{
...
<File name="functions/tsconfig.json">
  <Cog />
</File>
```json
{
...
<Figure 
  src="/img/content/snippets/nest-cloud-functions-structure.png"
  caption="The file structure of Nest + Cloud Functions "
  height={459}
  width={918}
/>
...
<File name="functions/src/index.ts">
  <TypeScript />
</File>
```typescript
import * as functions from 'firebase-functions';

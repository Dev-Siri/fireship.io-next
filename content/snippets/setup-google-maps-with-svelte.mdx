...
<Figure
	src="/img/content/snippets/google-maps-enable.png"
	caption="Enable the Google Maps JavaScript API from a GCP or Firebase project."
	height={471}
	width={918}
/>
...
<Figure
	src="/img/content/snippets/svelte-google-maps.png"
	caption="Google Maps running in Svelte 3"
	height={656}
	width={754}
/>
...
<Figure
	src="/img/content/snippets/custom-google-maps.gif"
	caption="Use the Google Maps Wizard to customize your app with ease"
	height={600}
	width={338}
/>

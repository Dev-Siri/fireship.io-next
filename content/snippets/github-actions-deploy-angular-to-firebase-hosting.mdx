...
<Figure
  src="/img/content/snippets/repo-actions.png"
  alt="clicking actions tab in GitHub"
  height={77}
  width={918}
/>
...
<Figure
  src="/img/content/snippets/set-up-a-workflow.png"
  alt="Set up a workflow"
  height={116}
  width={918}
/>
...
<Figure
  src="/img/content/snippets/firebase-token.png"
  alt="add firebase token to Github"
  height={577}
  width={918}
/>

...
<Figure
  src="/img/content/snippets/git-fork.png"
  caption="clicking the git fork button on github"
  height={188}
  width={918}
/>
...
<Figure
  src="/img/content/snippets/git-pr.png"
  caption="pull requests on a github repo"
  height={274}
  width={918}
/>
...
<Figure
  src="/img/content/snippets/git-first-pr.png"
  caption="pull requests on a github repo"
  height={501}
  width={918}
/>

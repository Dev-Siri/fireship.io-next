...
{{< figure src="/img/content/snippets/firebase-google-signin.png" alt="enable the google signin method via the Firebase authentication tab" >}}
...
{{< figure src="/img/content/snippets/firestore-custom-user-data.png" alt="custom user data in the Firestore database" caption="Notice how the UID on the document also matches user's assigned UID from firebase auth." >}}
...
<ng-template #guest>
  ...
  <button (click)="auth.googleSignin()"><i class="fa fa-google"></i> Connect Google</button>
</ng-template>
...
{{< figure src="/img/content/snippets/login-google-popup.png" alt="Google signin popup via firebase" >}}
...
{{< figure src="/img/content/snippets/firestore-rules-auth.png" alt="Google signin popup via firebase" >}}

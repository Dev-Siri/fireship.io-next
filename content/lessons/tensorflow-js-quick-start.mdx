...
{{< figure src="/img/content/snippets/tfjs-mnist-demo.gif" caption="MNIST digit recognizer web app using TensorFlow.js" >}}
...
{{< figure src="/img/content/snippets/linear-regression.png" caption="Regression demo" >}}

After the model is trained, we will show the user a form input that will make a new prediction when the value changes. 


{{< figure src="/img/content/snippets/angular-tensorflow-train.gif" caption="Linear model demo" >}}

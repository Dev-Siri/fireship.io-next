...
{{< figure src="/img/content/snippets/dropzone-firebase-storage.png" alt="Firebase storage demo with multiple files" >}}
...
{{< figure src="/img/content/snippets/firestore-download-url.png" alt="Firebase storage uploads with a reference to Firestore" >}}

...
{{< figure src="/img/content/snippets/map2.gif" caption="realtime interaction between two maps" >}}
...
{{< figure src="/img/content/snippets/map1.gif" caption="use cartogram to quickly customize map styles" >}}

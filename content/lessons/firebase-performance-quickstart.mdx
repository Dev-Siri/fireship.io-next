...
{{< figure src="/img/content/snippets/config-fireperf.png" caption="Make sure you have the new Firebase config object with an appId property" >}}
...
@NgModule({
  ...
  imports: [BrowserModule, AngularFireModule.initializeApp(firebaseConfig), AngularFirePerformanceModule],
  providers: [],
...
{{< figure src="/img/content/snippets/firebase-performance-time.png" caption="Firebase Performance will automatically track page loads stats" >}}
...
{{< figure src="/img/content/snippets/login-perf.png" caption="Metrics related to the user login process" >}}

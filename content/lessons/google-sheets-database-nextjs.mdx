...
{{< figure src="/img/content/snippets/google-sheet-database.png" caption="Grab Google Sheets Spreadsheet ID" >}}
...
{{< figure src="/img/content/snippets/enable-google-sheets.png" caption="Enable Google Sheets API" >}}

### Get a Service Account Key

Click *manage*, then go to the *credentials* tab. Click on the **App Engine default service account**.

{{< figure src="/img/content/snippets/sheets-service-account.png" caption="Default service account" >}}

From there, click the *Keys* tab and add an new JSON key.

{{< figure src="/img/content/snippets/service-account-key.png" caption="Download service account key" >}}

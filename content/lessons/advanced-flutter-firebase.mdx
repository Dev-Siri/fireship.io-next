...
{{< figure src="/img/content/snippets/data-model-root.png" alt="The heroes root collection in Firestore" >}}

{{< figure src="/img/content/snippets/data-model-sub.png" alt="The weapons subcollection, i.e. the weapons owned by the hero" >}}

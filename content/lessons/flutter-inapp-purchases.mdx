...
{{< figure src="/img/content/snippets/in-app-purchases-demo.gif" caption="Demo of a consumable In App Purchase in Flutter on the Google Play Store" >}}
...
{{< figure src="/img/content/snippets/google-play-product.png" caption="Setup a merchant account and create a managed product" >}}
...
{{< figure src="/img/content/snippets/xcode-enable-in-app-purchases.png" caption="Enable In App Purchases in Xcode" >}}
...
{{< figure src="/img/content/snippets/app-store-connect-iap.png" caption="Create a product on App Store Connect" >}}

...
{{< figure src="/img/content/snippets/project-create.png" caption="Create a Firebase project" >}}
...
{{< figure src="/img/content/snippets/firebase-web-app.png" caption="Create a web app from the project settings panel" >}}
...
{{< figure src="/img/content/snippets/project-files.png" >}}
...
{{< figure src="/img/content/snippets/hosting-deploy.png" caption="And we're live" >}}
...
{{< figure src="/img/content/snippets/auth-google.png" caption="Enable Google Sign-in" >}}
...
{{< figure src="/img/content/snippets/demo-auth.png" caption="The current state of your demo should look similar to this" >}}
...
{{< figure src="/img/content/snippets/firestore-enable.png" caption="Enable Firestore in test mode. We will secure the database at the end of this tutorial." >}}
...
{{< figure src="/img/content/snippets/firestore-things.png" >}}
...
{{< figure src="/img/content/snippets/composite-index.png" caption="When you see this error, follow the link to create a composite index" >}}

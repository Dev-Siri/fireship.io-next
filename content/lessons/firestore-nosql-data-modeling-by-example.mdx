...
{{< figure src="/img/content/snippets/embedded-data-firestore-07.png" caption="Embedded document data" >}}
...
{{< figure src="/img/content/snippets/firestore-subcollection-09.png" caption="Subcollection" >}}
...
{{< figure src="/img/content/snippets/nosql-model-likes-04.png" caption="Likes model" >}}
...
{{< figure src="/img/content/snippets/nosql-group-chat-05.png" caption="Chat model" >}}

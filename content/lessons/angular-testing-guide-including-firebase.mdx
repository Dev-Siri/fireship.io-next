...
{{< figure src="/img/content/snippets/tdd-study.png" >}}
...
{{< figure src="/img/content/snippets/karama-spec-angular.gif" caption="The Karma test runner in Angular" >}}
...
{{< figure src="/img/content/snippets/protractor-spec-angular.gif" caption="" >}}

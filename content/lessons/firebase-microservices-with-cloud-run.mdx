...
{{< figure src="/img/content/snippets/container-registry.png" caption="You should now see your image in the Container Registry on GCP" >}}
...
{{< figure src="/img/content/snippets/cloud-run-nuxt.png" caption="Create a service for Nuxt on the Cloud Run dashboard" >}}

And that's basically it, you now have a server-rendered JavaScript app microservice hosted in a serverless environment.

{{< figure src="/img/content/snippets/cloud-run-deployed.png" caption="Navigate to the URL to view the deployed Nuxt app." >}}
...
{{< figure src="/img/content/snippets/nuxt-firebase-hosting.png" caption="Nuxt on Firebase Hosting" >}}

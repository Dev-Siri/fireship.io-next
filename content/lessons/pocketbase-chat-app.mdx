...
{{< figure src="/img/content/snippets/pocketbase-dashboard.png" caption="Pocketbase dashboard" >}}
...
{{< figure src="/img/content/snippets/pocketbase-relation.png" caption="Message belongs to User" >}}
...
{{< figure src="/img/content/snippets/linode-dashboard.png" caption="Linode dashboard" >}}

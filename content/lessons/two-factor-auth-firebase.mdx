...
{{< figure src="/img/content/snippets/2fa-firebase.png" caption="Actual SMS text and 2FA confirmation email from Firebase" >}}
...
{{< figure src="/img/content/snippets/enable-identity-platform.png" caption="Enable Identity Platform on Google cloud" >}}
...
{{< figure src="/img/content/snippets/mfa-email.png" caption="2 step verification confirmation from Firebase" >}}

...
{{< figure src="/img/content/snippets/animate-1.gif" caption="animated popover" >}}
...
{{< figure src="/img/content/snippets/animate-2.gif" caption="multi state animation" >}}
...
{{< figure src="/img/content/snippets/animate-3.gif" caption="keyframe animation" >}}
...
{{< figure src="/img/content/snippets/animate-4.gif" >}}
...
{{< figure src="/img/content/snippets/animate-5.gif" caption="animated list with query and stagger in angular" >}}

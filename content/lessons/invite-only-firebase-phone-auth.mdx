...
{{< figure src="/img/content/snippets/enable-phone-auth.png" caption="Enable phone auth from the Firebase Auth console" >}}
...
{{< figure src="/img/content/snippets/invite-data-model.png" caption="Firestore invites collection" >}}
  ...
  return (
    <div>
      ...
      <fieldset>
        ...
        {invited ? <p className="success">You are one of the cool kids! 👋</p> : <p className="danger">This phone number is not cool 😞</p>}
      </fieldset>
    </div>
  );
}
...
{{< figure src="/img/content/snippets/text-firebase.png" caption="Phone auth verification text from Firebase" >}}
...
{{< figure src="/img/content/snippets/plivo-dashboard.png" caption="Plivo dashboard" >}}
...
{{< figure src="/img/content/snippets/text-plivo.png" caption="Invite text message from Plivo" >}}

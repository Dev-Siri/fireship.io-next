...
{{< figure src="/img/content/snippets/flare-star.png" caption="Draw a star" >}}
...
{{< figure src="/img/content/snippets/flare-star-animated.png" caption="Animate the fill color of the star" >}}
...
{{< figure src="/img/content/snippets/flare-star-rotate.png" caption="Animate the rotation of the star and change the key interpolation to cubic" >}}
...
{{< figure src="/img/content/snippets/flare-star-vert.png" caption="Use the verticies to change and animate the points of the shape" >}}
...
{{< figure src="/img/content/snippets/flare-animated-stroke.png" caption="Animate the stroke end from 0% to 100%" >}}
...
{{< figure src="/img/content/snippets/flare-star-clip.png" caption="Create another shape to serve as a clipping box for the star. " >}}
...
{{< figure src="/img/content/snippets/flare-export-screen.png" caption="Export the binary file from Flare" >}}

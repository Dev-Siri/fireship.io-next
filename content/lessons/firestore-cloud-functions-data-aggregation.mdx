...
{{< figure src="/img/content/snippets/aggregate-firestore.gif" caption="Data aggregation to speed up firestore document reads" >}}
...
{{< figure src="/img/content/snippets/agg-pattern.png" caption="Aggregation pattern in NoSQL" >}}

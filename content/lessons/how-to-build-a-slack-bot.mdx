...
{{< figure src="/img/content/snippets/slack-app-create.png" caption="Create a Slack App" >}}
...
{{< figure src="/img/content/snippets/slack-bot-url.png" caption="Copy the Function URL from the terminal output" >}}
...
{{< figure src="/img/content/snippets/slack-app-event.png" caption="Subscribe to the member_joined_channel event. Notice how our URL is now verified." >}}
...
{{< figure src="/img/content/snippets/slack-app-install.png" caption="Install the app into your workspace." >}}

Once installed, it will take you directly to the **OAuth token**. It usually starts with `xoxb` or `xoxp`.

{{< figure src="/img/content/snippets/slack-oauth-token.png" caption="Copy the OAuth Token" >}}
...
{{< figure src="/img/content/snippets/slack-events.png" >}}
...
export const myBot = functions.https.onRequest(async (req, res) => {
  ...
  await pubsubClient.topic("slack-channel-join").publisher().publish(dataBuffer);
...
```typescript
export const slackChannelJoin = functions.pubsub.topic("slack-channel-join").onPublish(async (message, context) => {
...
{{< figure src="/img/content/snippets/slack-app-slash.png" caption="Slash commands follow the same basic flow as events" >}}

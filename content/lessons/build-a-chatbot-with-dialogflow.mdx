...
{{< figure src="/img/content/snippets/agent.png" caption="Create the Dialogflow Agent " >}}
...
{{< figure src="/img/content/snippets/intent-train.png" caption="" >}}
...
{{< figure src="/img/content/snippets/params.png" alt="Dialogflow action and params" >}}
...
{{< figure src="/img/content/snippets/webhook-fulfill.png" alt="Dialogflow webhook fulfillment" >}}
...
{{< figure src="/img/content/snippets/functions-service-account.png" caption="Download your service account" >}}
...
<nb-chat title="Conversation with a Bot">
  ...
  <nb-chat-message *ngIf="loading" [nbSpinner]="loading" nbSpinnerStatus="info" type="text" avatar="/assets/bot.jpeg" message="...">
  </nb-chat-message>

  <nb-chat-form (send)="handleUserMessage($event)" [dropFiles]="true"> </nb-chat-form>
</nb-chat>
```

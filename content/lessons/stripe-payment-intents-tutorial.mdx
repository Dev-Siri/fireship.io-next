...
{{< figure src="/img/content/snippets/stripe-new-product.png" >}}
...
{{< figure src="/img/content/snippets/stripe-api-keys.png" caption="Initialize Stripe in Svelte with the publishable key" >}}
...
{{< figure src="/img/content/snippets/stripe-api-keys.png" caption="Initialize Stripe in your Cloud Functions with the secret key" >}}
...
<section>
  ...
  <button on:click="{submitPayment}" disabled="{!paymentIntent" || !complete}>Submit Payment for ${amount / 100}</button>
</section>
```
...
{{< figure src="/img/content/snippets/stripe-webhook-setup.png" caption="Create a webhook that points to your deploy Cloud Function endpoint" >}}

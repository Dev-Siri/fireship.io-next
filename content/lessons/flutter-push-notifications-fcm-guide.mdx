...
{{< figure src="/img/content/snippets/notification-foreground.png" caption="The appearance of a notification when running in the foreground with an AlertDialog widget " >}}
...
{{< figure src="/img/content/snippets/notification-background.png" caption="The appearance of a notification in the device tray in the background" >}}
...
{{< figure src="/img/content/snippets/segmented-notification.png" alt="segmented push notification FCM" >}}
...
{{< figure src="/img/content/snippets/fcm-token-firestore.png" caption="Firestore data model for managing single device FCM tokens" >}}

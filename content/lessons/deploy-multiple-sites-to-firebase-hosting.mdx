...
{{< figure src="/img/content/snippets/multisite-demo.gif" caption="Demo of multiple sites hosted by single Firebase Project" >}}
...
{{< figure src="/img/content/snippets/dist-i18n.png" caption="Multiple languages in dist translated in Angular" >}}
...
{{< figure src="/img/content/snippets/multisite-hosting.png" caption="Add multiple sites from the Firebase Console" >}}
...
{{< figure src="/img/content/snippets/connect-domain.png" caption="Connect your own domain to multiple firebase sites" >}}

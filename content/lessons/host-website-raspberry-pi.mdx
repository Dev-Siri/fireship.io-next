...
{{< figure src="/img/content/snippets/rpi-kit.jpg" caption="Popular Raspberry Pi kit" >}}
...
{{< figure src="/img/content/snippets/nginx-welcome.png" caption="You should now see the nginx welcome screen" >}}
...
{{< figure src="/img/content/snippets/port-forward.png" caption="The port forwarding setup on a Netgear router" >}}
...
{{< figure src="/img/content/snippets/rpi-hosting-comment.png" >}}

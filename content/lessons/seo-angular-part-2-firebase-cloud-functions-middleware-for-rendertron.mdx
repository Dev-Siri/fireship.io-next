...
{{< figure src="/img/content/snippets/slack-linkbot-angular.png" caption="Slackbot preview link" >}}
...
{{< figure src="/img/content/snippets/seo-dom-angular.png" caption="Parsed DOM with href tags" >}}
...
{{< figure src="/img/content/snippets/valid-open-graph-angular5.png" caption="Valid OpenGraph tags" >}}

...
{{< figure src="/img/content/snippets/paypal-api-credentials.png" caption="PayPal API credentials" >}}
...
{{< figure src="/img/content/snippets/paypal-mock-account.png" caption="Mock PayPal accounts for payment testing" >}}

...
{{< figure src="/img/content/snippets/hammer-home.png" caption="HammerJS homepage" >}}
...
{{< figure src="/img/content/snippets/hammer-demo.gif" caption="HammerJS demo with Angular Material Animations" >}}

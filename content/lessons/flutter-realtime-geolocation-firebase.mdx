...
{{< figure src="/img/content/snippets/flutter-basic-googlemap.png" alt="A blank basic Flutter Google Map" >}}
...
{{< figure src="/img/content/snippets/flutter-marker-googlemap.png" alt="Flutter google map with basic markers" >}}
...
{{< figure src="/img/content/snippets/firestore-geolocation.png" alt="The database structure for geolocation queries" >}}
...
{{< figure src="/img/content/snippets/firestore-radius-query.png" alt="Query within a radius Flutter Firestore app" >}}

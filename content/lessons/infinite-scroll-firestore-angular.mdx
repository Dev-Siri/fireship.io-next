...
{{< figure src="/img/content/snippets/infinite-scroll-firestore1.gif" caption="Upward infinite scroll angular firestore" >}}

### Upward Scrolling

It also supports upward scrolling by prepending new items. 

{{< figure src="/img/content/snippets/infinite-scroll-firestore2.gif" caption="Downward infinite scroll angular firestore" >}}

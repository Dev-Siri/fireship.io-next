...
{{< figure src="/img/content/snippets/webrtc-diagram.svg" caption="Breakdown of WebRTC signaling process. Source Mozilla" >}}
...
{{< figure src="/img/content/snippets/webrtc-firestore-calls.png" caption="Call document in Firestore" >}}

Each call document contains a subcollection for `answerCandidates` and `offerCandidates`.

{{< figure src="/img/content/snippets/webrtc-firestore-candidates.png" caption="Candidates subcollections" >}}

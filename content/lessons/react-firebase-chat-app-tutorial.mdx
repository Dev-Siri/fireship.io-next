...
{{< figure src="/img/content/snippets/react-firebase-chat.png" caption="React Firebase Chat Demo" >}}
...
{{< figure src="/img/content/snippets/banned-firestore.png" caption="Example of banned document in Firestore. Does not require any fields." >}}

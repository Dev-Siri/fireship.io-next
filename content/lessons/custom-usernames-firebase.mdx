...
{{< figure src="/img/content/snippets/username-demo.gif" caption="Demo of custom usernames in Firebase" >}}
...
{{< figure src="/img/content/snippets/username-vs-displayname.png" caption="The username is unique, while the displayname is not" >}}
...
{{< figure src="/img/content/snippets/user-doc.png" caption="The user document is used for public-facing data" >}}
...
{{< figure src="/img/content/snippets/username-doc.png" caption="The username document is used for uniqueness validation" >}}

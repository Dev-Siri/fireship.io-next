...
{{< figure src="/img/content/snippets/firebase-passwordless.png" caption="Enable email link method" >}}
...
{{< figure src="/img/content/snippets/firebase-email-link-auth.png" caption="Auth email sent by Firebase" >}}

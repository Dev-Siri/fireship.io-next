...
{{< figure src="/img/content/snippets/rxjs-trends.png" caption="RxJS is one of the most popular functional JS libraries as of 2019, generating more NPM downloads than the big-three UI frameworks and continuing to grow fast" >}}

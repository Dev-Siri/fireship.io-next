...
{{< figure src="/img/content/snippets/facebook-bot-angular.gif" caption="Valid Facebook links" >}}
...
{{< figure src="/img/content/snippets/rendertron-local.png">}}
...
{{< figure src="/img/content/snippets/valid-twitter-card-angular.png" caption="Valid Twitter Card" >}}

...
{{< figure src="/img/content/snippets/gcp-translate.png" caption="Enable translate via Google cloud platform" >}}
...
{{< figure src="/img/content/snippets/translate.gif" caption="Final translation microservice with Firebase Cloud Functions" >}}

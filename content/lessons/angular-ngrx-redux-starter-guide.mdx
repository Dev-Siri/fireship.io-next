...
{{< figure src="/img/content/snippets/ngrx-redux-pattern-diagram.png" caption="A diagram of how data flows in Redux with Angular NgRx" >}}
...
{{< figure src="/img/content/snippets/redux-ngrx-angular.gif" caption="redux state log" >}}
...
{{< figure src="/img/content/snippets/redux-plugin-ngrx.gif" caption="The redux plugin for Chrome makes debugging NgRx a breeze" >}}

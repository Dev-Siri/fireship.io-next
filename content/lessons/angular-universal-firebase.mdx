...
{{< figure src="/img/content/snippets/ssr-cannot-be-reached.png" alt="broken universal app" >}}
...
{{< figure src="/img/content/snippets/working-universal-app.png" alt="working universal app" >}}
...
{{< figure src="/img/content/snippets/angular-appengine.png" alt="angular universal app deployed to app engine" >}}
...
<File name="webpack.server.config.js">
  <JavaScript />
</File>
...
<File name="functions/cp-angular.js">
  <JavaScript />
</File>
...
{{< figure src="/img/content/snippets/angular-twitter-card.png" alt="Angular Universal cloud functions twitter card validator" >}}

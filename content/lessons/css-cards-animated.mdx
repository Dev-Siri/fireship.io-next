...
{{< figure src="/img/content/snippets/cards-original.png" caption="The original version on CSS tricks" >}}

{{< figure src="/img/content/snippets/cards-clone.png" caption="The cloned card stack" >}}

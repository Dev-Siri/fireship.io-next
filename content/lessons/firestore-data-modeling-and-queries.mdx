...
{{< figure src="/img/content/snippets/firestore-query-console.png" alt="Making a query in firestore directly from the console" >}}
...
{{< figure src="/img/content/snippets/firestore-has-one.png" alt="A has one relationship in Firestore" >}}
{{< figure src="/img/content/snippets/firestore-belongs-to.png" alt="A belongs-to relationship in Firestore" >}}

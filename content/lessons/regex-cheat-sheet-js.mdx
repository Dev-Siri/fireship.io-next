...
{{< figure src="/img/content/snippets/regex-password.png" caption="Validate a password with RegEx (via regexr.com)" >}}
...
{{< figure src="/img/content/snippets/regex-hex.png" caption="Find all of the hex codes with RegEx (via regexr.com)" >}}
...
{{< figure src="/img/content/snippets/regex-html.png" caption="Find all HTML tags with RegEx (via regexr.com)" >}}

...
{{< figure src="/img/content/snippets/hash.png" caption="hash function diagram" >}}
...
{{< figure src="/img/content/snippets/salt.png" caption="salt diagram" >}}
...
{{< figure src="/img/content/snippets/hmac.png" caption="hmac diagram" >}}
...
{{< figure src="/img/content/snippets/symmetric-encryption.png" caption="symmetric encryption diagram" >}}
...
<File name="symmetric-encryption.js">
  <JavaScript />
</File>
```javascript
...
{{< figure src="/img/content/snippets/keypairs.png" caption="keypair diagram" >}}

### Generate an RSA Keypair in Node.js

<File name="keypair.js">
  <JavaScript />
</File>
```javascript
...
{{< figure src="/img/content/snippets/asymmetric-encryption.png" caption="asymmetric encryption diagram" >}}

### RSA Encryption in Node.js

<File name="asymmetric-encryption.js">
  <JavaScript />
</File>
```javascript
...
{{< figure src="/img/content/snippets/signing.png" caption="signing diagram" >}}

### RSA Signing in Node.js

<File name="signing.js">
  <JavaScript />
</File>
```javascript

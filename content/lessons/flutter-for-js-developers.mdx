...
{{< figure src="/img/content/snippets/js-dart-reddit.png" alt="Post comparing Dart and JS from reddit" >}}
...
{{< figure src="/img/content/snippets/flutter-v-react-styles.png" alt="comparison of code footprint between react native and flutter" >}}
...
{{< figure src="/img/content/snippets/state-flutter-v-react.png" alt="comparison of code footprint between react native and flutter for managing component state" >}}

...
{{< figure src="/img/content/snippets/geohash-problem.png" caption="The problem with querying a single geohash" >}}
...
{{< figure src="/img/content/snippets/geoquery-firestore.gif" caption="Demo of geospatial query in Firestore" >}}

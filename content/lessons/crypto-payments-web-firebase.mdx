...
{{< figure src="/img/content/snippets/coinbase-payment-flow.png" caption="Coinbase Payment Flow (courtesy of Coinbase)" >}}
...
{{< figure src="/img/content/snippets/coinbase-api-keys.png" caption="Coinbase API keys" >}}

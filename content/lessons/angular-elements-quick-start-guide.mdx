...
{{< figure src="/img/content/snippets/elements-page-load.png" caption="Angular elements page load unoptimized" >}}
...
{{< figure src="/img/content/snippets/elements-page-load-optimized.png" caption="Page load performance increase by deferring the script" >}}

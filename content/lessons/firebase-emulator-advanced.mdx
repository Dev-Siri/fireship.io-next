...
{{< figure src="/img/content/snippets/emulator-fake-data.png" caption="Use TamperMonkey to run the script automatically" >}}
...
<File name="cypress/integration/example-spec.js">
  <JavaScript />
</File>

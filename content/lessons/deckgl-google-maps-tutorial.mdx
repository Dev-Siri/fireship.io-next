...
{{< figure src="//img/content/snippets/snippets/google-maps-enable.png" caption="Enable the Google Maps JavaScript API from a GCP project. Copy the browser API key from the credentials page." >}}
...
{{< figure src="/img/content/snippets/webpack-deckgl-structure.png" caption="Your project structure should look like this." >}}
...
<head>
  ...
  <script defer src="https://maps.googleapis.com/maps/api/js?key=API-KEY&callback=initMap"></script>
...
{{< figure src="/img/content/snippets/google-map-webpack.png" caption="Google Maps with Webpack HMR" >}}
...
{{< figure src="/img/content/snippets/deckgl-scatter-layer.png" caption="ScatterPlot layer with tooltips" >}}
...
{{< figure src="/img/content/snippets/deckgl-heat-layer.png" caption="Heatmap Layer" >}}
...
{{< figure src="/img/content/snippets/deckgl-hex-layer.png" caption="Hexagon Layer" >}}

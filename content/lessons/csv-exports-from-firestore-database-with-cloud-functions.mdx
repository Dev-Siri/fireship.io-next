...
{{< figure src="/img/content/snippets/csv-firebase-cloud-functions-demp.gif" caption="Firestore data converted to CSV via background Cloud Function" >}}
...
{{< figure src="/img/content/snippets/csv-fcf-angular.png" caption="CSV file in storage bucket" >}}

...
{{< figure src="/img/content/snippets/swagger-angular-ts.png" caption="Using swagger to build the clientside API code in Angular." >}}
...
{{< figure src="/img/content/snippets/http-get-angular.gif" caption="Example of get request using Angular HTTP Client" >}}
...
{{< figure src="/img/content/snippets/http-post-angular.gif" caption="Result of POST request" >}}

...
{{< figure src="/img/content/snippets/basic-datalab.png" caption="Datalab Python notebook" >}}
...
{{< figure src="/img/content/snippets/firebase-datalab.png" caption="Enable the ML Engine API" >}}
...
{{< figure src="/img/content/snippets/hist-datalab.png" caption="Showing a histogram in DataLab" >}}
...
{{< figure src="/img/content/snippets/cloud-build-api.png" caption="" >}}
{{< figure src="/img/content/snippets/ml-engine-api.png" caption="" >}}
...
{{< figure src="/img/content/snippets/ml-engine-model.png" caption="Create a model and version on ML Engine" >}}

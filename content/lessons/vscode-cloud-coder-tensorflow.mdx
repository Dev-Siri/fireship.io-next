...
{{< figure src="/img/content/snippets/coder-gcp-settings.png" caption="The recommended VM settings for Coder on GCP" >}}

### SSH into your VM

Now we need to interact with the VM from the command line. Go to the instance details page and click on the SSH button.

{{< figure src="/img/content/snippets/vm-open-ssh.png" caption="Start an SSH session with your Google Cloud VM"  >}}
...
{{< figure src="/img/content/snippets/vm-ip-link.png" caption="Click on the external IP link" >}}

Initially, you will see this warning from the browser. Click _Advanced -> Proceed Anyway_

{{< figure src="/img/content/snippets/vscode-web-warning.png" caption="This is not actually unsafe because we own the VM" >}}

You need a password to access the editor, which was automatically generated in the terminal output.

{{< figure src="/img/content/snippets/coder-password.png" caption="Copy the password in the middle of the terminal output" >}}

After entering the password you should have access to VS code in the browser.

{{< figure src="/img/content/snippets/vscode-coder-demo.png" caption="Done! Access VS Code and your files from any device, anywhere!" >}}
...
{{< figure src="/img/content/snippets/firewall-rule.png" caption="After creating the rule, make sure to tag your VM with with it under its settings" >}}

...
{{< figure src="/img/content/snippets/facebook-ui-redesign.png" caption="Facebook's new UI in 2020" >}}
...
{{< figure src="/img/content/snippets/react-navbar.png" caption="A basic flexbox navbar in React" >}}
...
{{< figure src="/img/content/snippets/react-icon-button-nav.png" caption="SVG Icon buttons for navigation" >}}
...
{{< figure src="/img/content/snippets/react-dropdown-basic.png" caption="A basic dropdown" >}}
...
{{< figure src="/img/content/snippets/react-dropdown-multi-level.png" caption="A multi-level dropdown in React" >}}
...
function DropdownMenu() {
  ...
  return (
    <div className="dropdown">
      ...
      <CSSTransition in={activeMenu === "settings"} timeout={500} classNames="menu-secondary" unmountOnExit>
        <div className="menu">

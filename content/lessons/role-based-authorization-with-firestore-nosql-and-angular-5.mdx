...
{{< figure src="/img/content/snippets/role-route-guard.gif" caption="Role-based auth demo" >}}
...
{{< figure src="/img/content/snippets/role-firestore-rules.gif" caption="Role-based Firestore Rules" >}}

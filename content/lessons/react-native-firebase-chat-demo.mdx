...
{{< figure src="/img/content/snippets/data-model.png" caption="Firestore data model for chat app" >}}
...
<File name="screens/loginScreen.js">
  <JavaScript />
</File>
```jsx
...
<File name="screens/chatScreen.js">
  <JavaScript />
</File>
```jsx
...
<File name="screen/chatScreen.js">
  <JavaScript />
</File>
```jsx
const ChatScreen = () => {

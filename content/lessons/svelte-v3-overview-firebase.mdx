...
{{< figure src="/img/content/snippets/todo-document-model.png" caption="Data model of todo item in Firestore" >}}
...
{{< figure src="/img/content/snippets/composite-index.png" caption="Check the browser error logs for a link to create this index"  >}}

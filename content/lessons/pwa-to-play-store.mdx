...
{{< figure src="/img/content/snippets/googleplay-badge.png" >}}
...
{{< figure src="/img/content/snippets/android-studio.png" alt="install android studio on your system" >}}
...
{{< figure src="/img/content/snippets/lighthouse-twa.png" alt="lighthouse score of 80+ for TWA on Google Play store" >}}
...
{{< figure src="/img/content/snippets/create-keystore.png" alt="Create a keystore in Android Studio" >}}
...
{{< figure src="/img/content/snippets/well-known-asset.png" alt="Well know asset deployed to firebase hosting" >}}
...
{{< figure src="/img/content/snippets/android-test-track.png" alt="Android test track streen" >}}
...
{{< figure src="/img/content/snippets/signed-apk.png" alt="Signed APK" >}}
...
{{< figure src="/img/content/snippets/google-play-store-listing.png" alt="Update the store listing on google play" >}}

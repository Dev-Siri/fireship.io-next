...
{{< figure src="//img/content/snippets/snippets/apple-signin-app1.png" alt="Apple Developer Portal App IDs" >}}
{{< figure src="//img/content/snippets/snippets/apple-signin-app2.png" caption="Make sure Sign In with Apple is Enabled" >}}
...
{{< figure src="//img/content/snippets/snippets/apple-signin-web-config.png" caption="Replace the project ID for your domain" >}}
...
{{< figure src="//img/content/snippets/snippets/apple-signin-verify.png" caption="You should see a green checkmark next to the domain" >}}
...
{{< figure src="//img/content/snippets/snippets/apple-signin-private-key.png" caption="Download the private key. Do not expose it publicly." >}}
...
{{< figure src="//img/content/snippets/snippets/apple-signin-firebase-console.png" caption="Copy the contents of the private key in the console" >}}
...
{{< figure src="//img/content/snippets/snippets/apple-signin-popup.png" caption="SignIn with Apple popup seen by the end-user" >}}

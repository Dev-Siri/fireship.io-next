...
{{< figure src="/img/content/snippets/google-calendar-firebase-demo.gif" caption="Using Google Calendar with Firebase" >}}
...
{{< figure src="/img/content/snippets/firebase-auth-custom-scope.png" caption="Additional scopes requested for firebase auth" >}}

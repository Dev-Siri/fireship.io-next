...
{{< figure src="/img/content/snippets/bigquery-upload-data.png" caption="Upload horses.csv to a cloud storage bucket"  >}}
...
{{< figure src="/img/content/snippets/bigquery-console.png" caption="The big query web UI"  >}}
...
{{< figure src="/img/content/snippets/bigquery-create-table.png" >}}
{{< figure src="/img/content/snippets/bigquery-create-table2.png" caption="Follow these configuration options closely. Set the schema to auto-detect and the 'Header rows to skip' to 1 under the advanced tab"  >}}
...
{{< figure src="/img/content/snippets/bigquery-schema.png" >}}
...
{{< figure src="/img/content/snippets/bigquery-datastudio.png"  >}}
...
{{< figure src="/img/content/snippets/bigquery-shell.png" >}}
...
{{< figure src="/img/content/snippets/bigquery-shell2.png"  caption="Open the web preview, but make sure to change the port to 8081" >}}
...
{{< figure src="/img/content/snippets/bigquery-datalab.png" caption="Run '%%bq tables list' and you should see the table we created in BigQuery" >}}
...
{{< figure src="/img/content/snippets/bigquery-ml-model.png" caption="This will take a few minutes, then the ML model should appear in the BigQuery dataset" >}}
...
{{< figure src="/img/content/snippets/bigquery-ml-results.png" >}}
...
{{< figure src="/img/content/snippets/bigquery-ml-predict.png" caption="The final model predictions that we can take to the racetrack" >}}

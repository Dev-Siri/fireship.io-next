...
{{< figure src="/img/content/snippets/iam-cloud-build.png" alt="grant permission to cloud build via IAM on google cloud" >}}
...
{{< figure src="/img/content/snippets/container-firebase.png" alt="firebase container in the register GCP" >}}
...
{{< figure src="/img/content/snippets/cloudbuild-trigger.png" alt="github cloud build trigger" >}}
...
{{< figure src="/img/content/snippets/cloud-build-fail.png" alt="cloud build results" >}}
...
{{< figure src="/img/content/snippets/kms-keyring.png" alt="create a keyring on GCP" >}}

Next, create a key for your secrets - let's give it a name of **cloudbuild-env**.

{{< figure src="/img/content/snippets/kms-key.png" alt="create the crypto key" >}}

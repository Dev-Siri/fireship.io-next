...
{{< figure src="/img/content/snippets/sendgrid-template.png" caption="SendGrid transactional template with dynamic values" >}}
...
{{< figure src="/img/content/snippets/sendgrid-restricted-apikey.png" caption="SendGrid API Key Settings" >}}
...
{{< figure src="/img/content/snippets/sendgrid-firestore.png" caption="Firestore data model for posts/comments. Email will send when a new comment is created." >}}
...
{{< figure src="/img/content/snippets/result-email.png" caption="Result in Gmail" >}}

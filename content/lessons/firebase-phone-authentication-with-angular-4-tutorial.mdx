...
{{< figure src="/img/content/snippets/phonecaptcha.gif" caption="visible recaptcha for firebase phone login angular" >}}
...
{{< figure src="/img/content/snippets/image1-576x1024.png" caption="phone auth sms text confirmation " >}}
...
{{< figure src="/img/content/snippets/phonesuccess.gif" caption="result of successful Firebase phone auth" >}}

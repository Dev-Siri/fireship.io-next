...
{{< figure src="/img/content/snippets/enable-secret-manager.png" caption="Enable the Secret Manager API" >}}
...
{{< figure src="/img/content/snippets/create-secret.png" caption="Create a secret from the console" >}}
...
{{< figure src="/img/content/snippets/iam-cloud-functions.png" caption="Add Secret Accessor role to the App Engine default service account" >}}

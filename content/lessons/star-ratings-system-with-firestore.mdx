...
{{< figure src="/img/content/snippets/many-to-many-through-nosql-06.png" caption="Example of a many-to-many-through relationship" >}}
...
{{< figure src="/img/content/snippets/firestore-relational-data-stars.gif" caption="Realtime star reviews demo" >}}
...
{{< figure src="/img/content/snippets/firestore-star.png" caption="Star reviews in the database" >}}

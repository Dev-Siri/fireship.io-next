...
{{< figure src="/img/content/snippets/presence-demo.gif" alt="realtime presence with Angular and Firebase" caption="The browser on the left shows the actual user activity, while the browser on the right is just a neutral observer of the presence changes" >}}
...
{{< figure src="/img/content/snippets/rtdb-presence.png" alt="realtime database model for presence system" >}}

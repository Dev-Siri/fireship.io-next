...
{{< figure src="/img/content/snippets/stripe-metered-product.png" caption="Create a metered product on Stripe" >}}
...
{{< figure src="/img/content/snippets/stripe-checkout-form.png" caption="Example of Stripe Checkout form" >}}
...
app.get("/api", async (req, res) => {
  ...
  if (!customer || !customer.active) {
    ...
    const record = await stripe.subscriptionItems.createUsageRecord(customer.itemId, {
      quantity: 1,
      timestamp: "now",
      action: "increment",
    });

...
{{< figure src="/img/content/snippets/basic.png" alt="basic margin and padding on flutter widget" >}}
...
{{< figure src="/img/content/snippets/row.png" alt="row of three boxes in Flutter" >}}

{{< figure src="/img/content/snippets/col.png" alt="column of three boxes in Flutter" >}}
...
{{< figure src="/img/content/snippets/cross-aligned.png" alt="aligned boxes Flutter" >}}
...
{{< figure src="/img/content/snippets/expanded.png" alt="expanded flex widget in Flutter" >}}
...
{{< figure src="/img/content/snippets/aligned.png" alt="aligned boxes Flutter" >}}
...
{{< figure src="/img/content/snippets/positioned.png" alt="positioned boxes Flutter" >}}

...
{{< figure src="/img/content/snippets/algolia-firestore-demo.png" caption="Notice how the Algolia index (left) is synced-up with the Firestore document (right)" >}}
...
{{< figure src="/img/content/snippets/create-index.png" caption="Create an index named customers on the Algolia dashboard" >}}
...
{{< figure src="/img/content/snippets/api-keys.png" caption="You need the Algolia App ID and Admin API Key" >}}

...
{{< figure src="/img/content/snippets/hotdog-ionic-vision.gif" caption="Demo of Not Hotdog App in Ionic" >}}
...
{{< figure src="/img/content/snippets/vision-enable.png" caption="Enable cloud vision from the GCP console" >}}
...
{{< figure src="/img/content/snippets/firestore-vision-data.png" caption="Cloud Vision data" >}}

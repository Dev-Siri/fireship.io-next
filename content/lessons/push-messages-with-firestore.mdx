...
{{< figure src="/img/content/snippets/fcm-demo-angular.gif" caption="firebase cloud messaging demo in angular" >}}
...
{{< figure src="/img/content/snippets/fcm-demo-angular5.gif" caption="firebase cloud messaging receive inside angular component" >}}

...
{{< figure src="/img/content/snippets/cloud-vision-text-ocr.png" caption="Text extraction demo using Google Cloud Vision" >}}
...
{{< figure src="/img/content/snippets/cloud-vision-doc.png" caption="Data returned from the Cloud Vision API" >}}

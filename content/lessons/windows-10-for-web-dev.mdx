...
{{< figure src="/img/content/snippets/win-terminal-admin.png" caption="Open PowerShell in Windows 10 as an administrator" >}}
...
{{< figure src="/img/content/snippets/win-linux-distros.png" caption="Install your favorite Linux flavor" >}}
...
{{< figure src="/img/content/snippets/win-terminal-app.png" caption="Install windows terminal and start a Linux session" >}}
...
{{< figure src="/img/content/snippets/win-wsl-extension.png" caption="Remote WSL extension" >}}
...
{{< figure src="/img/content/snippets/win-docker-desktop.png" caption="Docker Desktop. Notice the WSL2 option" >}}

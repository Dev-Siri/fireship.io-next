...
{{< figure src="/img/content/snippets/formarray-demo.gif" caption="demo of Angular FormArray" >}}
...
{{< figure src="/img/content/snippets/form-validation-demo.gif" caption="Demo of form validation" >}}

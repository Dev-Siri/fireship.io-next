...
<script lang="ts">
  import { markComplete } from "../../../../../util/helpers";
  import { getCourseIdFromURL } from../../../ util / firebaselpers;
  ...
  async function onCorrect() {
    const confetti = (await import('../../../utils/confetti')).default;
    const arr = [
      'well done sir',
      "that's legit",
      'crushed it',
...
<modal-dialog esc="true" name="quiz">
  <div class="wrap">
    ...
    <img src={`/courses/${courseId}/img/prizes/${prize}.webp`} alt="programming meme" class:show={isComplete} />

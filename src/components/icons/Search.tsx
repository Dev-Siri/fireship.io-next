export default function Search() {
  return (
    <svg
      ...
      viewBox="0 0 512 512"
    >
      <g fill="currentColor" className="fk-group">
        <path
        ...
        />
        <path
          d="M504.9 476.7 476.6 505a23.9 23.9 0 0 1-33.9 0L343 405.3a24 24 0 0 1-7-17V372l36-36h16.3a24 24 0 0 1 17 7l99.7 99.7a24.11 24.11 0 0 1-.1 34z"
